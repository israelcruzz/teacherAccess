...
const Register = () => {
  return (
    <div className="grid grid-cols-2 w-full h-[100vh] overflow-hidden">
      <div
      ...
      <div className="h-full w-full p-32 flex flex-col items-center justify-center">
        <FormTeacher title="Create an account" description="Enter your email below to create your account" btnOne="Create" btnTwo="Login" name={true}/>
      </div>
    </div>
  );
};
